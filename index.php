...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home || Online Water Ordering System - Code Camp BD</title>
...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/img/wrs.webp">
            ...
            <div class="container text-center hero-text font-white">
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Choose Water</h4>
                    </div>
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Order Water</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Popular Water of the Month</h2>
                <p class="lead">Easiest way to order your favourite water</p>
            </div>
            <div class="row">
                <?php 					
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Choose a Water Refilling Station Branch</h3>
                                <p>We"ve got your covered with water from a variety of delivery branches online.</p>
                            </div>
                        </div>
                    </div>
